    ...
    <div className="flex h-full w-full flex-col bg-surface" data-node-id="1:9">
      <div className="relative h-[340px] shrink-0 overflow-hidden rounded-b-[30px] bg-surface-cream">
        <div className="absolute left-6 top-10 flex items-center">
          <span className="font-['Pretendard'] text-[27px] font-black tracking-[-1.2px] text-text-primary">
            MALL
          </span>
          <span className="ml-px flex size-[23px] items-center justify-center rounded-full bg-primary text-[14px] font-black tracking-[-1.2px] text-text-primary">
            O
          </span>
        </div>
        ...
        <div className="absolute left-[96px] top-[93px] flex w-[200px] items-end gap-4">
          ...
          <div className="absolute left-[-28px] top-3 whitespace-nowrap rounded-2xl rounded-bl-xl bg-white px-3 py-2 text-[17px] font-bold text-text-link shadow-[0_1px_1.5px_rgba(0,0,0,0.1),0_1px_1px_rgba(0,0,0,0.1)]">
            오늘은?
          </div>
      ...
      <div className="flex flex-1 flex-col px-6 pt-7">
        <h1 className="text-[25px] font-bold tracking-[-0.625px] text-text-primary">
          아이는 말로 자랍니다
        </h1>
        ...
        <div className="mt-6 rounded-2xl border-[0.5px] border-border bg-surface p-4 shadow-[0_4px_7px_rgba(50,31,0,0.04)]">
          ...
          <p className="mt-2 text-[15px] font-semibold text-text-primary">대화를 들려주세요</p>
          <p className="mt-1 text-[13px] text-text-subtle">발화량 · 어휘 · 질문을 분석해요</p>
        </div>
        ...
        <div className="flex flex-1 flex-col justify-end pb-8 pt-4">
          <Link
            to="/signup"
            className="flex h-[52px] w-full items-center justify-center gap-1.5 rounded-[20px] bg-primary text-[15px] font-semibold text-text-primary shadow-[0_6px_8px_rgba(255,161,2,0.18)]"
          >
            말로 시작하기
          ...
          <Link
            to="/home"
            className="mt-3 text-center text-sm font-medium text-text-link"
          >
            이미 계정이 있어요
          </Link>
