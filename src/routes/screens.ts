...
export const screens: ScreenEntry[] = [
  ...
  { path: "/report", label: "리포트 화면", figmaNodeId: "1:750", implemented: false },
  { path: "/report/detail", label: "리포트 화면 - 상세 보기", figmaNodeId: "1:902", implemented: false },
  { path: "/report/open-question", label: "리포트 화면 - 열린질문 상세 데이터", figmaNodeId: "1:1045", implemented: false },
  { path: "/coaching", label: "코칭 화면", figmaNodeId: "1:1135", implemented: false },
  { path: "/coaching/script", label: "코칭 화면 - 스크립트 전체 보기", figmaNodeId: "1:1232", implemented: false },
  { path: "/report/export", label: "리포트 화면 - 내보내기", figmaNodeId: "1:1295", implemented: false },
  { path: "/settings", label: "설정 화면", figmaNodeId: "1:1370", implemented: false },
  { path: "/settings/delete", label: "설정 화면 - 데이터 삭제 요청", figmaNodeId: "1:1488", implemented: false },
];
